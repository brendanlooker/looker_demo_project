- dashboard: simple_html_elements_on_dashboardsnext
  title: Simple HTML elements on Dashboards-Next
  layout: newspaper
  ...
  - name: " (4)"
    ...
    body_text: "<div style=\"\n\theight: 64px; \n\tbackground-color: #fff; \n\tcolor:\
      ...
      \ \n\ttext-align:center; \n\tmargin-right: 12px; \n\tfloat: left;\">\n<img width=\"\
      32px\" src=\"https://storage.googleapis.com/brechtv/Looker_Favicon_32x32%403x.png\"\
      />\n</span>\n\n<span style=\"\n\tpadding: 4px; \n\tfloat:left;\">\n\t<h1 style=\"\
      \n\t\tcolor: #5f6368; \n\t\tline-height: 1.4rem;\">\n\t\tDCL Operations KPIs\n\
      \t</h1>\n\t<p>A breakdown of DCL Ops' KPIs</p>\n</span>\n<span style=\"padding:\
      \ 4px; float:right; line-height: 2.4rem;\">\n\t<a style=\"background-color:\
      \ #fff; color: #5f6368; padding: 5px 10px;\" href=\"#\">Home</a>\n\t<a style=\"\
      background-color: #fff; color: #5f6368; padding: 5px 10px;\" href=\"#\">Another\
      \ link</a>\n\t<a style=\"background-color: #fff; color: #5f6368; padding: 5px\
      \ 10px;\" href=\"#\">Third Link</a>\n</span>\n\n<div>\n"
    row: 2
    col: 0
    width: 24
    height: 2
  ...
  - name: " (7)"
    ...
    body_text: "<div style='background-color: #fff; padding: 5px 10px; border: solid\
      ...
      \ target=\"_blank\">here</a>. Copy the HTML snippet with the SVG path and add\
      \ a style attribute where you set the color and the size of the icon. For example:<code><svg\
      \ style='fill: red; height: 64px;' class=\"svg-icon\" ...</code>\n</p>\n<br>\n\
      \n<svg style='fill: #4285F4; height: 64px;' class=\"svg-icon\" viewBox=\"0 0\
      ...
      \n<svg style='fill: #EA4335; height: 64px;'  class=\"svg-icon\" viewBox=\"0\
      ...
      ></path>\n\t\t\t\t\t\t</svg>\n\n<svg style='fill: #FBBC04; height: 64px;'  class=\"\
      ...
      ></path>\n\t\t\t\t\t\t</svg>\n\n<svg style='fill: #34A852; height: 64px;' class=\"\
      svg-icon\" viewBox=\"0 0 20 20\">\n\t\t\t\t\t\t\t<path d=\"M6.176,7.241V6.78c0-0.221-0.181-0.402-0.402-0.402c-0.221,0-0.403,0.181-0.403,0.402v0.461C4.79,7.416,4.365,7.955,4.365,8.591c0,0.636,0.424,1.175,1.006,1.35v3.278c0,0.222,0.182,0.402,0.403,0.402c0.222,0,0.402-0.181,0.402-0.402V9.941c0.582-0.175,1.006-0.714,1.006-1.35C7.183,7.955,6.758,7.416,6.176,7.241\
      \ M5.774,9.195c-0.332,0-0.604-0.272-0.604-0.604c0-0.332,0.272-0.604,0.604-0.604c0.332,0,0.604,0.272,0.604,0.604C6.377,8.923,6.105,9.195,5.774,9.195\
      \ M10.402,10.058V6.78c0-0.221-0.181-0.402-0.402-0.402c-0.222,0-0.402,0.181-0.402,0.402v3.278c-0.582,0.175-1.006,0.714-1.006,1.35c0,0.637,0.424,1.175,1.006,1.351v0.461c0,0.222,0.181,0.402,0.402,0.402c0.221,0,0.402-0.181,0.402-0.402v-0.461c0.582-0.176,1.006-0.714,1.006-1.351C11.408,10.772,10.984,10.233,10.402,10.058M10,12.013c-0.333,0-0.604-0.272-0.604-0.604S9.667,10.805,10,10.805c0.332,0,0.604,0.271,0.604,0.604S10.332,12.013,10,12.013M14.629,8.448V6.78c0-0.221-0.182-0.402-0.403-0.402c-0.221,0-0.402,0.181-0.402,0.402v1.668c-0.581,0.175-1.006,0.714-1.006,1.35c0,0.636,0.425,1.176,1.006,1.351v2.07c0,0.222,0.182,0.402,0.402,0.402c0.222,0,0.403-0.181,0.403-0.402v-2.07c0.581-0.175,1.006-0.715,1.006-1.351C15.635,9.163,15.21,8.624,14.629,8.448\
      \ M14.226,10.402c-0.331,0-0.604-0.272-0.604-0.604c0-0.332,0.272-0.604,0.604-0.604c0.332,0,0.604,0.272,0.604,0.604C14.83,10.13,14.558,10.402,14.226,10.402\
      \ M17.647,3.962H2.353c-0.221,0-0.402,0.181-0.402,0.402v11.27c0,0.222,0.181,0.402,0.402,0.402h15.295c0.222,0,0.402-0.181,0.402-0.402V4.365C18.05,4.144,17.869,3.962,17.647,3.962\
      \ M17.245,15.232H2.755V4.768h14.49V15.232z\"></path>\n\t\t\t\t\t\t</svg>\n</div>"
    row: 22
    col: 13
    width: 11
    height: 5
  ...
  - name: " (10)"
    ...
    body_text: |2
      ...
      <h1 style="margin-top:20px; padding: 5px; border-bottom: solid 1px #412399; height: 60px; color: #412399; text-align: center;" id="buttons">Buttons</h1>
    row: 27
    col: 0
    width: 24
    height: 2
  ...
  - name: " (12)"
    ...
    body_text: "<div style=\"border: solid 1px #4285F4; border-radius: 5px; padding:\
      ...
      font-size: 28px;\">Business Pulse</h1>\n\t</div>\n<nav style=\"font-size: 18px;\
      \ position: absolute; bottom: 0; text-align: center;\">\n  <a style=\"padding:\
      \ 5px; line-height: 40px; font-weight: bold;\" href=\"#home\">\n  \t<svg style=\"\
  ...
  - name: " (15)"
    ...
    body_text: |-
      ...
      <h1 style="font-family: 'Google Sans', Arial, sans-serif; ">Google Cloud - Looker</h1>
      <p style="font-family: 'Google Sans', Arial, sans-serif; ">bcadfaf</p>
    row: 33
    col: 0
    width: 24
    height: 2
  - name: " (16)"
    ...
    title_text: ''
    subtitle_text: ''
    body_text: <iframe width="560" height="315" src="https://www.youtube.com/embed/Oqs__6rfk9c"
  ...
  - name: " (17)"
    ...
    body_text: |-
      ...
      <div style="width: 28px; height: 28px; border-radius: 32px; background-color: white; display:table-cell; vertical-align:middle; text-align:center; margin-right: 12px;">
      <img width="16px" src="https://storage.googleapis.com/brechtv/Looker_Favicon_32x32%403x.png"/>
      </div>
      <div ><h1 style="color: white; line-height: 1.8rem;">This is a header</h1></div>
      <div>
    row: 4
    col: 0
    width: 24
